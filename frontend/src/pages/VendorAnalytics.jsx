    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Detailed analytics and performance insights</p>
        </div>

        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          <div className="text-6xl mb-4">📈</div>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Business Analytics</h2>
          <p className="text-gray-600 mb-6">This page is under development. You'll get detailed analytics here soon!</p>
          <button 
            onClick={() => navigate('/vendor/dashboard')}
